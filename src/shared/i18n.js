...
const DICTIONARIES = {
  en: {
    ...
    "settings.explainMode": "Explain",
    "settings.explainOff": "Off",
    "settings.explainShort": "Short",
    "settings.explainFull": "Full",
    "settings.explainHint": "Show a live-only reason after the move. Never saved.",
    "explain.thinking": "AI's thinking",
  ...
  vi: {
    ...
    "settings.explainMode": "Giải thích",
    "settings.explainOff": "Tắt",
    "settings.explainShort": "Ngắn",
    "settings.explainFull": "Đầy đủ",
    "settings.explainHint": "Hiện lý do trực tiếp sau nước đi. Không bao giờ lưu.",
    "explain.thinking": "Suy nghĩ của AI",
