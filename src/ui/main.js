...
try {
  app = new App({
    ...
    thinkingCard: {
      root: byIdOptional("thinking-card"),
      summary: byIdOptional("thinking-card-summary"),
      body: byIdOptional("thinking-card-body"),
    },
    turn: byId("turn"),
    ...
    battle: {
      root: byIdOptional("battle-section"),
      opponentTab: byIdOptional("battle-opponent-tab"),
      opponentColor: byIdOptional("battle-opponent-color"),
      minutes: byIdOptional("battle-minutes"),
      increment: byIdOptional("battle-increment"),
      start: byIdOptional("battle-start"),
      pause: byIdOptional("battle-pause"),
      resume: byIdOptional("battle-resume"),
      askAgain: byIdOptional("battle-ask-again"),
      abort: byIdOptional("battle-abort"),
      rematch: byIdOptional("battle-rematch"),
      export: byIdOptional("battle-export"),
      exportAll: byIdOptional("battle-export-all"),
      status: byIdOptional("battle-status"),
      ledger: byIdOptional("battle-ledger"),
      history: byIdOptional("battle-history"),
    },
    studio: {
      root: byIdOptional("studio-section"),
      platform: byIdOptional("studio-platform"),
      style: byIdOptional("studio-style"),
      funRow: byIdOptional("studio-fun-row"),
      funSentences: byIdOptional("studio-fun-sentences"),
      metrics: byIdOptional("studio-metrics"),
      budgetHint: byIdOptional("studio-budget-hint"),
      preview: byIdOptional("studio-preview"),
      copy: byIdOptional("studio-copy"),
    },
    match: {
    ...
    diagnostics: {
      ...
      timeline: byIdOptional("latency-timeline"),
      copyTimeline: byIdOptional("copy-timeline"),
    },
    promotionDialog: {
