...
- If AI writes `e5` without brackets, board won't parse it — nudge the AI: _"Please always return your move in brackets like [e7e5]"_
...
- Just tell the AI: _"That move is illegal in this FEN: <paste FEN>. Please choose another legal move for Black in [brackets]."_
