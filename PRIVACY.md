...
- The copyable Diagnostics report includes privacy-safe **reply-path codes** (how the reply was attributed, the verdict, a count of skipped prompt echoes) — codes and counts only, never message text, FENs or titles.
