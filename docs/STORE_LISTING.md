...
- sidePanel: Show board
- activeTab: Identify active AI tab
- scripting: Ensure bridge on AI pages
- Hosts: Only AI chat domains listed above
...
## Icon Sizes Required
- 16x16, 48x48, 128x128 PNG — chess knight or board with AI sparkle
- Currently missing — needs design (see TODO)
...
- [ ] Take 3-5 screenshots 1280x800
- [ ] Add promotional tile 440x280, marquee 1400x560 (optional)
- [ ] Test on all 7 hosts
- [ ] Prepare privacy policy URL (link to PRIVACY.md in repo or hosted)
