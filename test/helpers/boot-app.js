  ...
  const app = new App(
    {
      ...
      thinkingCard: {
        root: elements["thinking-card"],
        summary: elements["thinking-card-summary"],
        body: elements["thinking-card-body"],
      },
      turn: elements.turn,
      ...
      settingsDialog: {
        ...
        controls: {
          ...
          explainMode: elements["settings-explain-mode"],
